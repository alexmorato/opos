...
## 🏛️ **EJEMPLO AYUNTAMIENTO BARCELONA**

### **📋 PROCESO: Actualización Padrón Municipal**

```

┌─────────────────────────────────────┐
│ APLICACIÓN ANTIGUA DE PADRÓN (1990) │
│   • Sin APIs                         │
│   • Solo interfaz verde/mainframe    │
└───────────────┬─────────────────────┘
                │
                ▼
          [UIPATH RPA]
          • Accede con credenciales
          • Navega menús (F1, F3, Enter)
          • Extrae datos de pantallas
          • Guarda en CSV
                │
                ▼
        ┌───────────────┐
        ...
        └───────┬───────┘
                │
                ▼
       [UC4/AUTOMIC WORKFLOW]
       1. Valida formato CSV ✓
       2. Ejecuta Python: limpia datos
       3. Conecta a Oracle: inserta
       4. Genera reporte PDF
       5. Notifica a Sistemas vía email
                │
                ▼
┌─────────────────────────────────────┐
│   BASE DE DATOS ORACLE ACTUAL       │
